	...
	public HttpClientV4Utils() {
		...
		if (httpclient != null) {
			...
			httpclient.getParams().setParameter(
					CoreConnectionPNames.CONNECTION_TIMEOUT, conn_timeout);
			// 设置request的响应时间 15秒
			httpclient.getParams().setParameter(
					CoreConnectionPNames.SO_TIMEOUT, data_timeout);
		}

		// v4.3版设置超时
		// 设置请求和传输超时时间
		// requestConfig =
		// RequestConfig.custom().setSocketTimeout(conn_timeout).setConnectTimeout(data_timeout).build();
